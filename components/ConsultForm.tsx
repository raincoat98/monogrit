...
import { Zap, Gift, Lock, Map, MapPin, Plane, CheckCircle, type LucideIcon } from 'lucide-react'
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input type="text" placeholder="홍길동" required className="px-3.5 py-2.5 border-[1.5px] border-gray-200 rounded-lg text-sm text-gray-800 bg-gray-50 outline-none focus:border-brand focus:bg-white focus:shadow-[0_0_0_3px_rgba(26,86,219,0.08)] transition-all" />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-[12px] font-bold text-gray-800">연락처 *</label>
                  <input type="tel" placeholder="010-0000-0000" required className="px-3.5 py-2.5 border-[1.5px] border-gray-200 rounded-lg text-sm text-gray-800 bg-gray-50 outline-none focus:border-brand focus:bg-white focus:shadow-[0_0_0_3px_rgba(26,86,219,0.08)] transition-all" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input type="email" placeholder="email@example.com" className="px-3.5 py-2.5 border-[1.5px] border-gray-200 rounded-lg text-sm text-gray-800 bg-gray-50 outline-none focus:border-brand focus:bg-white focus:shadow-[0_0_0_3px_rgba(26,86,219,0.08)] transition-all" />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-[12px] font-bold text-gray-800">희망 국가</label>
                  <select className="px-3.5 py-2.5 border-[1.5px] border-gray-200 rounded-lg text-sm text-gray-800 bg-gray-50 outline-none focus:border-brand focus:bg-white focus:shadow-[0_0_0_3px_rgba(26,86,219,0.08)] transition-all">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea placeholder="궁금하신 점을 자유롭게 적어주세요." className="px-3.5 py-2.5 border-[1.5px] border-gray-200 rounded-lg text-sm text-gray-800 bg-gray-50 outline-none focus:border-brand focus:bg-white focus:shadow-[0_0_0_3px_rgba(26,86,219,0.08)] transition-all resize-y min-h-[86px]" />
              </div>
              ...
              <button
                ...
                className={`shimmer w-full flex items-center justify-center gap-2 py-4 rounded-lg font-bold text-[15px] text-white border-none cursor-pointer transition-all ${
                  submitted ? 'bg-green-600 cursor-default' : 'bg-brand hover:bg-brand-dark shadow-brand-sm hover:shadow-brand-md'
                }`}
              >
                {submitted ? (
